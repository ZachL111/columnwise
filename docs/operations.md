...
`columnwise` is centered on data engineering work in Julia. The technical target is: Implement dictionary-encoded columns and predicate pushdown scans.
...
The score is deterministic. The current threshold is 151. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 6.
