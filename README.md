...
columnwise is a Julia project for data engineering. It focuses on this technical goal: Implement dictionary-encoded columns and predicate pushdown scans.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 151, risk penalty 6, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
