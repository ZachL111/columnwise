"""Regression checks for the columnwise casebook."""
...
from casebook.harness import assert_expected, columnwise_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(columnwise_summary(), assert_expected())
